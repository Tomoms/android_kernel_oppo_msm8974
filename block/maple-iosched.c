...
/* Tunables */
static const int sync_read_expire = 50;	/* max time before a read sync is submitted. */
static const int sync_write_expire = 200;	/* max time before a write sync is submitted. */
static const int async_read_expire = 100;	/* ditto for read async, these limits are SOFT! */
static const int async_write_expire = 250;	/* ditto for write async, these limits are SOFT! */
